...
Go check out this other repo with some code i did not include: https://github.com/hxr404/Discord-Console-hacks
...
## Apply annie/dark build override
...
## Change channel type (in some in some cases setting it to 0 will crash your discord)
